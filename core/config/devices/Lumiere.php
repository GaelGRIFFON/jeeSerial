...
$deviceConfiguration = array(
    'lumiere' => array(
        ...
        'isVisible' => 1,
        'isEnable' => 1,
        'category' => array('light' => '1'),
        'commands' => array(
            array('name' => 'on', 'type' => 'action', 'subtype' => 'other', 'isVisible' => 1, 'isHistorized' => 0, 'unite' => '', 'eventOnly' => 0,
                'logicalId' => 'M',
                'value' => 'Etat',
                'template' => '{"dashboard":"light","mobile":"light"}',
				'configuration' => array(
                    'deltaAdresse' => '20'
                )
            ),
            array('name' => 'off', 'type' => 'action', 'subtype' => 'other', 'isVisible' => 1, 'isHistorized' => 0, 'unite' => '', 'eventOnly' => 0,
                'logicalId' => 'A',
                'value' => 'Etat',
                'template' => '{"dashboard":"light","mobile":"light"}',
				'configuration' => array(
            ...
            array('name' => 'Etat', 'type' => 'info', 'subtype' => 'binary', 'isVisible' => 0, 'isHistorized' => 0, 'unite' => '', 'eventOnly' => 1,
				'logicalId' => 'E',
				'configuration' => array(
                    'deltaAdresse' => '00'
                )
